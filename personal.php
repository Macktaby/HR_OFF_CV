...
<div>
	<form Method ="POST" action="personal.php">
		...
		<h1>Personal Information</h1>
		  ...
		  <span style="color:red">*</span><label for="firstname">First Name</label><br>
		  <input type="text" name="firstname" value="" placeholder="Enter First Name ..." required>
		<br>
		  <span style="color:red">*</span><label for="lastname">Last Name</label><br>
		...
		<br>
		  ...
		  <select name="gender" placeholder="Enter your Gender ...">
		     <option value="" title="" placeholder="Enter your Gender ..."></option>
			 <option value="Male" title="">Male</option>
			 <option value="Female" title="">Female</option>
		  </select>
		<br>
		...
		<br>
		  ...
		  <select name="Country" placeholder="Enter your Country ...">
